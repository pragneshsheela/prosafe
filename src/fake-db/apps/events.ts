// Type Imports
import type { EventsType } from '@/types/apps/ecommerceTypes'

export const db: EventsType = {
  Events: [
    {
      id: 1,
      Eventname: 'iPhone 14 Pro',
      Zone: 'Electronics',
      Type: true,
      Date: 19472,
      AssignedTo: '$999',
      ...
      Actions: 'Super Retina XDR display footnote Pro Motion technology'
    },
    {
      id: 2,
      Eventname: 'Echo Dot (4th Gen)',
      Zone: 'Electronics',
      Type: false,
      Date: 72836,
      AssignedTo: '$25.50',
      ...
      Actions: 'Echo Dot Smart speaker with Alexa'
    },
    {
      id: 3,
      Eventname: 'Dohioue Wall Clock',
      Zone: 'Accessories',
      Type: false,
      Date: 29540,
      AssignedTo: '$16.34',
      ...
      Actions: 'Modern 10 Inch Battery Operated Wall Clocks'
    },
    {
      id: 4,
      Eventname: 'INZCOU Running Shoes',
      Zone: 'Shoes',
      Type: false,
      Date: 49402,
      AssignedTo: '$36.98',
      ...
      Actions: 'Lightweight Tennis Shoes Non Slip Gym Workout Shoes'
    },
    {
      id: 5,
      Eventname: 'Apple Watch Series 7',
      Zone: 'Office',
      Type: false,
      Date: 46658,
      AssignedTo: '$799',
      ...
      Actions: 'Starlight Aluminum Case with Starlight Sport Band.'
    },
    {
      id: 6,
      Eventname: 'Meta Quest 2',
      Zone: 'Office',
      Type: true,
      Date: 57640,
      AssignedTo: '$299',
      ...
      Actions: 'Advanced All-In-One Virtual Reality Headset'
    },
    {
      id: 7,
      Eventname: 'MacBook Pro 16',
      Zone: 'Electronics',
      Type: true,
      Date: 92885,
      AssignedTo: '$2648.95',
      ...
      Actions: 'Laptop M2 Pro chip with 12‑core CPU and 19‑core GPU'
    },
    {
      id: 8,
      Eventname: 'SAMSUNG Galaxy S22 Ultra',
      Zone: 'Electronics',
      Type: true,
      Date: 75257,
      AssignedTo: '$899',
      ...
      Actions: 'Android Smartphone, 256GB, 8K Camera'
    },
    {
      id: 9,
      Eventname: 'Air Jordan',
      Zone: 'Shoes',
      Type: false,
      Date: 31063,
      AssignedTo: '$125',
      ...
      Actions: 'Air Jordan is a line of basketball shoes produced by Nike'
    },
    {
      id: 10,
      Eventname: 'VISKABACKA',
      Zone: 'Home Decor',
      Type: false,
      Date: 91848,
      AssignedTo: '$190.45',
      ...
      Actions: 'Armchair, Skartofta black/light grey'
    },
    {
      id: 11,
      Eventname: 'Nintendo Switch',
      Zone: 'Games',
      Type: true,
      Date: 52575,
      AssignedTo: '$296.99',
      ...
      Actions: 'TV Mode, Tabletop Mode, Handheld Mode'
    },
    {
      id: 12,
      Eventname: 'PlayStation 5',
      Zone: 'Games',
      Type: true,
      Date: 59551,
      AssignedTo: '$499',
      ...
      Actions: 'Marvel at incredible graphics and experience'
    },
    {
      id: 13,
      Eventname: 'Amazon Fire TV',
      Zone: 'Electronics',
      Type: false,
      Date: 5829,
      AssignedTo: '$263.49',
      ...
      Actions: '4K UHD smart TV, stream live TV without cable'
    },
    {
      id: 14,
      Eventname: 'Smiletag Ceramic Vase',
      Zone: 'Home Decor',
      Type: false,
      Date: 24456,
      AssignedTo: '$34.99',
      ...
      Actions: 'Modern Farmhouse Decor Vase Set of 3'
    },
    {
      id: 15,
      Eventname: 'Apple iPad',
      Zone: 'Electronics',
      Type: true,
      Date: 35946,
      AssignedTo: '$248.39',
      ...
      Actions: '10.2-inch Retina Display, 64GB'
    },
    {
      id: 16,
      Eventname: 'BANGE Anti Theft Backpack',
      Zone: 'Office',
      Type: true,
      Date: 41867,
      AssignedTo: '$79.99',
      ...
      Actions: 'Smart Business Laptop Fits 15.6 Inch Notebook'
    },
    {
      id: 17,
      Eventname: 'Xbox Series X/S',
      Zone: 'Games',
      Type: true,
      Date: 43224,
      AssignedTo: '$49.99',
      ...
      Actions: 'Dual Controller Charger Station Dock'
    },
    {
      id: 18,
      Eventname: 'Canon EOS Rebel T7',
      Zone: 'Electronics',
      Type: true,
      Date: 63474,
      AssignedTo: '$399',
      ...
      Actions: '18-55mm Lens | Built-in Wi-Fi | 24.1 MP CMOS Sensor'
    },
    {
      id: 19,
      Eventname: 'Honiway Wall Mirror',
      Zone: 'Home Decor',
      Type: false,
      Date: 15859,
      AssignedTo: '$23.99',
      ...
      Actions: 'Decorative 12 inch Rustic Wood Mirror Sunburst Boho'
    },
    {
      id: 20,
      Eventname: 'Tommaso Veloce Shoes',
      Zone: 'Shoes',
      Type: false,
      Date: 28844,
      AssignedTo: '$922.09',
      ...
      Actions: 'Peloton Shoes Triathlon Road Bike Indoor Cycling'
    },
    {
      id: 21,
      Eventname: 'Zoolab',
    ...
    },
    {
      ...
      status: 'Published',
      image: '/images/apps/ecommerce/product-7.png',
      Actions: 'VonRueden, Rogahn and Kris'
    },
    {
      id: 28,
      Eventname: 'Rt',
      ...
      status: 'Published',
      image: '/images/apps/ecommerce/product-8.png',
      Actions: "Romaguera, O'Connell and Abernathy"
    },
    {
      id: 29,
      Eventname: 'Zontrax',
      ...
      status: 'Published',
      image: '/images/apps/ecommerce/product-9.png',
      Actions: 'Mills, Hagenes and Bednar'
    },
    {
      id: 30,
      Eventname: 'Keylex',
      ...
      status: 'Inactive',
      image: '/images/apps/ecommerce/product-10.png',
      Actions: 'Sanford, Harvey and Parisian'
    },
    {
      id: 31,
      Eventname: 'Trippledex',
      Zone: 'Home Decor',
      Type: false,
      Date: 51597,
      AssignedTo: '$312.03',
    ...
    },
    {
      ...
      status: 'Scheduled',
      image: '/images/apps/ecommerce/product-14.png',
      Actions: 'Barrows, Quitzon and Roberts'
    },
    {
      id: 35,
      Eventname: 'Tempsoft',
      ...
      status: 'Inactive',
      image: '/images/apps/ecommerce/product-15.png',
      Actions: 'Russel-Grant'
    },
    {
      id: 36,
      Eventname: 'Ventosanzap',
      Zone: 'Accessories',
      Type: true,
      Date: 69072,
      AssignedTo: '$756.81',
      ...
      status: 'Scheduled',
      image: '/images/apps/ecommerce/product-16.png',
      Actions: "O'Conner-Zboncak"
    },
    {
      id: 37,
      Eventname: 'Mat Lam Tam',
      Zone: 'Accessories',
      Type: false,
      Date: 68290,
      AssignedTo: '$256.86',
      ...
      status: 'Published',
      image: '/images/apps/ecommerce/product-17.png',
      Actions: 'Rutherford, Heller and Bashirian'
    },
    {
      id: 38,
      Eventname: 'Zamit',
    ...
    },
    {
      ...
      status: 'Inactive',
      image: '/images/apps/ecommerce/product-19.png',
      Actions: "O'Kon, Waelchi and Lesch"
    },
    {
      id: 40,
      Eventname: 'Viva',
      ...
      status: 'Published',
      image: '/images/apps/ecommerce/product-20.png',
      Actions: 'Johnston, Anderson and Metz'
    },
    {
      id: 41,
      Eventname: 'Matsoft',
      ...
      status: 'Published',
      image: '/images/apps/ecommerce/product-1.png',
      Actions: "O'Conner, Paucek and Braun"
    },
    {
      id: 42,
      Eventname: 'Wiodex',
    ...
    },
    {
      ...
      status: 'Inactive',
      image: '/images/apps/ecommerce/product-3.png',
      Actions: 'Haag, Bruen and Reichel'
    },
    {
      id: 44,
      Eventname: 'Konklux',
    ...
    },
    {
      ...
      status: 'Scheduled',
      image: '/images/apps/ecommerce/product-1.png',
      Actions: 'Kreiger, Reynolds and Sporer'
    },
    {
      id: 47,
      Eventname: 'Roldlamis',
    ...
    },
    {
      ...
      status: 'Scheduled',
      image: '/images/apps/ecommerce/product-7.png',
      Actions: 'Romaguera, Schmeler and Volkman'
    },
    {
      id: 49,
      Eventname: 'Span',
  ...
  customerData: [
    ...
    {
      id: 14,
      customer: 'AssignedTo Tremathack',
      customerId: '155681',
